export default function ListadoCargue() {
    const datos = [
      { lote: 'L-992', descripcion: 'HAMBURGUESA DE CARNE', cantidad: 80, estado: 'Buen estado' },
      { lote: 'L-995', descripcion: 'CARNE DE RES FRANCESA', cantidad: 60, estado: 'Buen estado' },
    ...
    return (
      <div className="border border-slate-100 rounded-2xl overflow-hidden font-['Inter'] bg-white shadow-sm">
        ...
        <div className="bg-[#A8D5BA]/20 p-5 border-b border-slate-100">
          <h3 className="text-[18px] font-bold text-slate-800 tracking-tight uppercase">En Inventario BINT</h3>
        </div>
