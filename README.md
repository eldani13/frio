...
Sistema frontend para gestionar una bodega de frío con 12 posiciones. Permite registrar objetos con id y temperatura, moverlos entre posiciones, retirarlos y buscar por id. El estado se sincroniza en Firebase Firestore para persistir y compartir entre sesiones.
...
- [app/components/BodegaDashboard.tsx](app/components/BodegaDashboard.tsx): lógica de negocio, estado y persistencia en Firestore.
...
El estado principal y el historial se guardan en Firebase Firestore bajo `warehouses/{WAREHOUSE_ID}/state/{main|history}`. Asegura que todas las sesiones vean la misma información sin depender de localStorage.
